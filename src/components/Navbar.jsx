        ...
        <>
            <nav>
                <div className="flex justify-between align-middle sm:flex-row flex-col px-5 py-3 bg-custom-navbar drop-shadow-md text-slate-900">
                    ...
                    {/*Main Navigates */}
                    <ul className={"text-center sm:flex justify-between sm:mx-0 sm:max-h-screen sm:transition-none "+(showMenu ? "max-h-screen transition-max-height duration-500 ease-in-out":"max-h-0 overflow-hidden")}>
