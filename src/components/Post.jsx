export default function Post() {
    ...
    const posts = Array.from({ length: 5 }, (_, i) => (
        <div key={i} className="container w-9/12 mx-auto my-5">
            {/* Post Header */}
            <div className="flex sm:flex-row flex-col justify-between mx-auto">
                <h3 className="md:text-lg text-base font-bold">UserName<span> (Badge)</span></h3>
                <span className="md:text-sm text-xs sm:self-center">台中市,沙鹿區</span>
            </div>
            {/* Post Img */}
